...
| [@calexandre](https://github.com/calexandre) | The max reasoning effort level and following the server's per-level flags ([#265](https://github.com/Vivswan/litellm-vscode-chat/issues/265), [#266](https://github.com/Vivswan/litellm-vscode-chat/issues/266); [#267](https://github.com/Vivswan/litellm-vscode-chat/pull/267) added max, closed unmerged, superseded by the resolvable level list) |
