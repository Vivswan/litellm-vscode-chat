...
- `litellm-vscode-chat.inlineCompletions.enabled`: the opt-in; nothing is registered and nothing is sent until you enable it, apart from the dashboard's explicit "Test model" button
