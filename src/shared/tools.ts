...
export function convertTools(
	...
	// The tools array is large and static across an agent session. Tag the last tool with an
	// ephemeral cache breakpoint so the whole tools prefix is cached and reused on every
	// subsequent request.
