...
describe("dashboard/recordDraft inheritance directives", () => {
	...
	describe("the _inherit_from row", () => {
	...
	describe("inheritFromChoice / setInheritFromChoice", () => {
	...
	describe("capabilityGroupsFromJsonText", () => {
