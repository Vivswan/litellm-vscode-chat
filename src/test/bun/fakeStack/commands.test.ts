...
import type { CommandContext } from "../../fakeStack/commands";
import {
	COMMAND_SIGIL,
	COMMANDS,
	dispatchCommand,
...
describe("fakeStack commands: recognition", () => {
...
describe("fakeStack commands: numeric domains and diagnostics", () => {
...
describe("fakeStack commands: tool flow", () => {
	const tools = [
