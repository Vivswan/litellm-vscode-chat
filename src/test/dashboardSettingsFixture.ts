...
export function makeSettings(overrides: Partial<DashboardSettings> = {}): DashboardSettings {
	return {
		...
		booleans: {
			...
			"prGeneration.enabled": false,
			"consultTool.enabled": false,
			"quickFix.enabled": false,
			"reviewComments.enabled": false,
			"chatParticipant.enabled": true,
			"agentTools.enabled": false,
			"agentTools.setSetting.enabled": false,
			"agentTools.editModelRecords.enabled": false,
			"agentTools.saveServer.enabled": false,
			"agentTools.removeServer.enabled": false,
			"agentTools.runAction.enabled": false,
			"agentTools.secretValues.enabled": false,
		},
		configuredScopes: {
			numbers: {
				"chat.timeout": null,
			...
			booleans: {
				...
				"prGeneration.enabled": null,
				"consultTool.enabled": null,
				"quickFix.enabled": null,
				"reviewComments.enabled": null,
				"chatParticipant.enabled": null,
				"agentTools.enabled": null,
				"agentTools.setSetting.enabled": null,
				"agentTools.editModelRecords.enabled": null,
				"agentTools.saveServer.enabled": null,
				"agentTools.removeServer.enabled": null,
				"agentTools.runAction.enabled": null,
				"agentTools.secretValues.enabled": null,
			},
		},
