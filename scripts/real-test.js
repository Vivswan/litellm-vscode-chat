...
//
// Usage:
//   bun run real-test -- <base-url> <api-key-or-> <model-id>
//
...
if (!baseUrl || !modelId) {
	console.error(`
Usage: bun run real-test -- <base-url> <api-key-or-> <model-id>
...
Environment variable fallbacks:
  LITELLM_REAL_BASE_URL, LITELLM_REAL_API_KEY, LITELLM_REAL_MODEL
`);
	process.exit(1);
}
