 ...
 * strings) come out identical on every render - a pixel baseline is
 * meaningless otherwise. Both sides import this one constant; a fixture
 * timestamp computed from anything else would drift against the page clock.
 */
