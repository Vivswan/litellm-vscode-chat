...
const TWO_PART_404: DashboardServer = {
	...
	error:
		...
		"the extension appends /v1 unless the URL already ends in a version segment like /v1 or /v2; LiteLLM's default " +
		"port is 4000.\nUnparseable response from https://litellm-eu.example.com/v1/models: Unexpected token '<', " +
