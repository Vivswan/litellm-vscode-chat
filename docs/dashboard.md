...
- Five destinations:
  ...
  - **Features** holds the extension's features beyond chat - inline completions, commit message generation, PR description generation, the consult tool, quick fixes, review comments, and the chat participant - each with its enable, model pick, and feature-specific rows ([Features](#features)).
