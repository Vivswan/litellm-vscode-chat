...
| 让聊天代理替我诊断或修改这个扩展的设置 | [快速入门: 代理工具配方](getting-started.md#让代理管理你的-litellm-设置) |
| 用我自己的模型修复或解释编辑器里的错误 | [快速入门: 快速修复配方](getting-started.md#修复或解释一条诊断) |
| 让模型评审我的代码并在相关行上留下评论 | [快速入门: 评审评论配方](getting-started.md#让模型评审你的代码) |
...
1. [快速入门](getting-started.md) - 安装、第一个服务器、第一次聊天, 以及一组针对最常见后续步骤的简短配方。
