...
| `litellm-vscode-chat.reviewComments.enabled` | `false` | Opt-in for AI review comments on your changes. Off by default; no comment threads exist and no review is sent until enabled ([recipe](getting-started.md#get-review-comments-on-your-code)) |
